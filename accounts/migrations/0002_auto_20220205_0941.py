...
def load_data(apps, schema_editor):
    ...
    OrganizationTypes = apps.get_model("accounts", "OrganizationTypes")
    oc = OrganizationTypes(type="School")
    oc.save()
    oc = OrganizationTypes(type="College")
    oc.save()
    oc = OrganizationTypes(type="NGO")
    oc.save()

    # occupation
    Occupation = apps.get_model("accounts", "Occupation")
    oc = Occupation(
        occupation="Doctors, senior administrative officers, lecturers, college principals, advocates, expert musicians, newspaper editors, auditors, architects etc"
    )
    oc.save()
    oc = Occupation(
        occupation="Clerks (Eg: general office clerks, administrative assistants, receptionists and office assistants, accountants)"
    )
    oc.save()
    oc = Occupation(
        occupation="Engineers, scientists, software development, paramedics, police officers, soldiers, crane operators, commercial truck drivers, mechanist, plumbers, craftsmen, cooks"
    )
    oc.save()
    oc = Occupation(occupation="Farmers & Fishermen")
    oc.save()
    oc = Occupation(occupation="Plant and Machine Operators and Assemblers")
    oc.save()
    oc = Occupation(
        occupation="Salesman, street vendor, housekeeper/ housemaid (hotels/ house), washing windows and other glass surfaces of buildings, security guard (housing societies/company/banks/land), stocking vending machines or reading and emptying meters, Garbage collector, sweeper"
    )
    oc.save()
    oc = Occupation(occupation="Business person")
    oc.save()
    oc = Occupation(occupation="Unemployed")
    oc.save()
    oc = Occupation(occupation="Nurse")
    oc.save()
    oc = Occupation(occupation="Anganwadi Worker")
    oc.save()
    oc = Occupation(occupation="Retired")
    oc.save()
    ...
    oc = Education(education="Professional degree (Post graduate)")
    oc.save()
    oc = Education(education="Graduate (Bachelors)")
    oc.save()
    oc = Education(education="Higher Secondary certificate (12th Std)")
    oc.save()
    oc = Education(education="Secondary school certificate (SSC - 10th Std)")
    oc.save()
    oc = Education(education="Middle school (5th to 10th std)")
    oc.save()
    oc = Education(education="Primary school (1st to 4th std)")
    oc.save()
    oc = Education(education="Illiterate (No education)")
    oc.save()

    # family type
    FamilyType = apps.get_model("accounts", "FamilyType")
    oc = FamilyType(family="Nuclear")
    oc.save()
    oc = FamilyType(family="Joint")
    oc.save()
    oc = FamilyType(family="Extended")
    oc.save()

    # religions
    ReligiousBelief = apps.get_model("accounts", "ReligiousBelief")
    oc = ReligiousBelief(religion="Hinduism")
    oc.save()
    oc = ReligiousBelief(religion="Islam")
    oc.save()
    oc = ReligiousBelief(religion="Christianity")
    oc.save()
    oc = ReligiousBelief(religion="Sikhism")
    oc.save()
    oc = ReligiousBelief(religion="Jainism")
    oc.save()
    oc = ReligiousBelief(religion="Buddhism")
    oc.save()

    # family income
    FamilyIncome = apps.get_model("accounts", "FamilyIncome")
    oc = FamilyIncome(family_income="> 199,862")
    oc.save()
    oc = FamilyIncome(family_income="99,931 - 199,861")
    oc.save()
    oc = FamilyIncome(family_income="74,755 - 99,930")
    oc.save()
    oc = FamilyIncome(family_income="49,962 - 74,755")
    oc.save()
    oc = FamilyIncome(family_income="29,973 - 49,961")
    oc.save()
    oc = FamilyIncome(family_income="10,002 - 29,972")
    oc.save()
    oc = FamilyIncome(family_income="< 10,001")
    oc.save()

    # ration card color
    RationCardColor = apps.get_model("accounts", "RationCardColor")
    oc = RationCardColor(ration_card_color="Red Color")
    oc.save()
    oc = RationCardColor(ration_card_color="Orange Color")
    oc.save()
    oc = RationCardColor(ration_card_color="White Color")
    oc.save()
    oc = RationCardColor(ration_card_color="No Ration Card")
    oc.save()
...
def delete_data(apps, schema_editor):
    OrganizationTypes = apps.get_model("accounts", "OrganizationTypes")
    OrganizationTypes.objects.all().delete()
    ...
    FamilyType = apps.get_model("accounts", "FamilyType")
    FamilyType.objects.all().delete()

    ReligiousBelief = apps.get_model("accounts", "ReligiousBelief")
    ReligiousBelief.objects.all().delete()

    FamilyIncome = apps.get_model("accounts", "FamilyIncome")
    FamilyIncome.objects.all().delete()

    RationCardColor = apps.get_model("accounts", "RationCardColor")
    RationCardColor.objects.all().delete()
